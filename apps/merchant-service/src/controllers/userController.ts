...
export const getMerchantProfile = asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
  const result = await userService.getMerchantProfile({ userSub: req.user?.sub });
  return res.json(result);
});

export const updateMerchantProfile = asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
...
export const updateMerchantAddress = asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
...
export const createStoreForUser: (req: Request, res: Response, next: NextFunction) => void =
...
export const deleteUser: (req: Request, res: Response, next: NextFunction) => void = asyncHandler(
