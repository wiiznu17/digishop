...
export const returnCarrierWebhook: (req: Request, res: Response, next: NextFunction) => void =
...
export const markReturnFailed: (req: Request, res: Response, next: NextFunction) => void =
  asyncHandler(async (req: Request, res: Response) => {
