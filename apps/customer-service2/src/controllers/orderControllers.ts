...
export const findOrder: RequestHandler = asyncHandler(
...
export const findUserOrder: RequestHandler = asyncHandler(
  async (req: Request, res: Response) => {
...
export const findUserCart: RequestHandler = asyncHandler(
  async (req: Request, res: Response) => {
    const id = req.params.id
...
export const deleteChart: RequestHandler = asyncHandler(
  async (req: Request, res: Response) => {
    const item = req.body
...
export const createOrderId: RequestHandler = asyncHandler(
  async (req: Request, res: Response) => {
...
export const deleteOrder: RequestHandler = asyncHandler(
  async (req: Request, res: Response) => {
    const id = req.params.id
...
export const findShipping: RequestHandler = asyncHandler(
  async (req: Request, res: Response) => {
...
export const createCart: RequestHandler = asyncHandler(
  async (req: Request, res: Response) => {
    const { customerId, productItemId, quantity } = req.body
    const result = await orderService.createCart(
      customerId,
      productItemId,
      quantity
    )
...
export const customerCancel: RequestHandler = asyncHandler(
  async (req: Request, res: Response) => {
    const id = req.params.id
...
export const customerCancelV2: RequestHandler = asyncHandler(
  async (req: Request, res: Response) => {
    const id = req.params.id
...
export const revokeCancelOrder: RequestHandler = asyncHandler(
  async (req: Request, res: Response) => {
    const id = req.params.id
...
export const cancelOrder: RequestHandler = asyncHandler(
  async (req: Request, res: Response) => {
    ...
    const correlationId =
      (req.headers['x-request-id'] as string) || `cust-${id}-${Date.now()}`
