...
export const searchProduct: RequestHandler = asyncHandler(
...
export const getAllProduct: RequestHandler = asyncHandler(
  async (req: Request, res: Response) => {
...
export const getStoreProduct: RequestHandler = asyncHandler(
  async (req: Request, res: Response) => {
    const id = req.params.id
