...
export function EditAddress({
  ...
  const handleOnConfirm = async () => {
    // patch address
    if (!user) return
    const updateAdd = (await updateAddress(user.id, address)) as {
      data: string
    }
    if (updateAdd.data) {
  ...
  return (
    <div>
      ...
      >
        ...
        >
          <div
            className={`fixed inset-0 z-100 w-screen overflow-y-auto  ${rubik.className} bg-black/50`}
          >
                        ...
                        <div className="space-y-6">
                          ...
                          {!item.isDefault && (
                            <div className="text-black">
                              ...
                              />
                              <label htmlFor="isDefault" className="ml-4 ">
                                Yes
                              </label>
                            </div>
                          )}
