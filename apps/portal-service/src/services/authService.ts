...
export class AuthService {
  async login(payload: { email?: string; password?: string }, ip: string, userAgent: string | null) {
  ...
  async refresh(token: string, ip: string, userAgent: string | null) {
    ...
    const sess = await authRepository.findActiveSession(payload.sub, payload.jti);
