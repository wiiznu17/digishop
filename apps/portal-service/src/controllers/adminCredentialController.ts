...
export const adminSendInviteById: RequestHandler = asyncHandler(
...
export const adminResetPasswordById: RequestHandler = asyncHandler(
  async (req: Request, res: Response) => {
    const id = Number(req.params.id)
...
export const adminAcceptInvite: RequestHandler = asyncHandler(
  async (req: Request, res: Response) => {
...
export const adminPerformReset: RequestHandler = asyncHandler(
  async (req: Request, res: Response) => {
