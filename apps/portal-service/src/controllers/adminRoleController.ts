...
export const adminGetRoleDetail: RequestHandler = asyncHandler(
  async (req: Request, res: Response) => {
...
export const adminCreateRole: RequestHandler = asyncHandler(
  async (req: Request, res: Response) => {
...
export const adminUpdateRoleMeta: RequestHandler = asyncHandler(
  async (req: Request, res: Response) => {
    const id = Number(req.params.id)
...
export const adminReplaceRolePermissions: RequestHandler = asyncHandler(
  async (req: Request, res: Response) => {
    const id = Number(req.params.id)
    const result = await adminRoleService.replaceRolePermissions(
      id,
      req.body ?? {}
    )
    res.json(result)
