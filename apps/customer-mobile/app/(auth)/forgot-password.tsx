...
export default function ForgotPasswordScreen() {
  ...
  return (
    <View className="flex-1 justify-center px-8 bg-white">
      <Text className="text-3xl font-bold text-blue-700 mb-2">Forgot Password</Text>
      ...
      {sent ? (
        <View className="bg-green-50 border border-green-300 rounded-xl p-4">
          <Text className="text-green-700 font-medium">✅ Reset email sent! Check your inbox.</Text>
        </View>
      ) : (
        <>
          ...
          <TouchableOpacity
            ...
            disabled={loading}
          >
            {loading ? <ActivityIndicator color="#fff" /> : <Text className="text-white font-bold">Send Reset Email</Text>}
          </TouchableOpacity>
        </>
      )}
    </View>
