...
export const createWishList = (data: { customerId: number; productItemId: number[]; quantity: number[] }) =>
...
export const cancelOrder = (id: number, data: { reason?: string; description?: string; contactEmail?: string }) =>
