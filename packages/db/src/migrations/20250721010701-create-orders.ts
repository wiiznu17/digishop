  ...
  async up(queryInterface: QueryInterface): Promise<void> {
    await queryInterface.createTable(
      "ORDERS",
      {
        ...
        subtotal_minor: { type: DataTypes.INTEGER.UNSIGNED, allowNull: false, defaultValue: 0 },
        shipping_fee_minor: { type: DataTypes.INTEGER.UNSIGNED, allowNull: false, defaultValue: 0 },
        tax_total_minor: { type: DataTypes.INTEGER.UNSIGNED, allowNull: false, defaultValue: 0 },
        discount_total_minor: { type: DataTypes.INTEGER.UNSIGNED, allowNull: false, defaultValue: 0 },
        grand_total_minor: { type: DataTypes.INTEGER.UNSIGNED, allowNull: false, defaultValue: 0 },
        ...
        // snapshots
        customer_name_snapshot: { type: DataTypes.STRING(200), allowNull: false },
        customer_email_snapshot: { type: DataTypes.STRING(254), allowNull: false },
