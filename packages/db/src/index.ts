...
export function initModels(conn: Sequelize) {
  ...
  User.hasMany(StoreView, {
    foreignKey: { name: 'userId', field: 'user_id' },
    as: 'storeViews'
  })
  StoreView.belongsTo(User, {
    foreignKey: { name: 'userId', field: 'user_id' },
    as: 'viewer'
  })
  ...
  Store.hasMany(ShippingConfig, {
    foreignKey: { name: 'storeId', field: 'store_id' },
    as: 'shippingConfigs',
    onDelete: 'CASCADE',
    onUpdate: 'CASCADE'
  })
  ShippingConfig.belongsTo(Store, {
    foreignKey: { name: 'storeId', field: 'store_id' },
    as: 'store',
    onDelete: 'CASCADE',
    onUpdate: 'CASCADE'
  ...
  Store.hasMany(StoreView, {
    foreignKey: { name: 'storeId', field: 'store_id' },
    as: 'views'
  })
  StoreView.belongsTo(Store, {
    foreignKey: { name: 'storeId', field: 'store_id' },
    as: 'store'
  })

  Store.hasMany(MerchantAddress, {
    foreignKey: { name: 'storeId', field: 'store_id' },
    as: 'addresses',
    onDelete: 'CASCADE',
    onUpdate: 'CASCADE'
  })
  MerchantAddress.belongsTo(Store, {
    foreignKey: { name: 'storeId', field: 'store_id' },
    as: 'store',
    onDelete: 'CASCADE',
    onUpdate: 'CASCADE'
  ...
  Store.hasOne(ProfileMerchantImage, {
    foreignKey: { name: 'storeId', field: 'store_id' },
    as: 'profileImages',
    onDelete: 'CASCADE',
    onUpdate: 'CASCADE'
  })
  ProfileMerchantImage.belongsTo(Store, {
    foreignKey: { name: 'storeId', field: 'store_id' },
    as: 'store',
    onDelete: 'CASCADE',
    onUpdate: 'CASCADE'
  ...
  Variation.hasMany(VariationOption, {
    foreignKey: { name: 'variationId', field: 'variation_id' },
    as: 'options',
    onDelete: 'CASCADE',
    onUpdate: 'CASCADE'
  })
  ...
  ProductItem.hasMany(ProductConfiguration, {
    foreignKey: { name: 'productItemId', field: 'product_item_id' },
    as: 'configurations',
    onDelete: 'CASCADE',
    onUpdate: 'CASCADE'
  })
  ProductConfiguration.belongsTo(ProductItem, {
    foreignKey: { name: 'productItemId', field: 'product_item_id' },
    as: 'productItem',
    onDelete: 'CASCADE',
    onUpdate: 'CASCADE'
  ...
  ProductItem.hasOne(ProductItemImage, {
    foreignKey: { name: 'productItemId', field: 'product_item_id' },
    as: 'productItemImage',
    onDelete: 'CASCADE',
    onUpdate: 'CASCADE'
  })
  ProductItemImage.belongsTo(ProductItem, {
    foreignKey: { name: 'productItemId', field: 'product_item_id' },
    as: 'productItem',
    onDelete: 'CASCADE',
    onUpdate: 'CASCADE'
  ...
  VariationOption.hasMany(ProductConfiguration, {
    foreignKey: { name: 'variationOptionId', field: 'variation_option_id' },
    as: 'configurations',
    onDelete: 'CASCADE',
    onUpdate: 'CASCADE'
  })
  ProductConfiguration.belongsTo(VariationOption, {
    foreignKey: { name: 'variationOptionId', field: 'variation_option_id' },
    as: 'variationOption',
    onDelete: 'CASCADE',
    onUpdate: 'CASCADE'
  ...
  CheckOut.hasOne(Payment, {
    foreignKey: { name: 'checkoutId', field: 'checkout_id' },
    as: 'payment',
    onDelete: 'CASCADE',
    onUpdate: 'CASCADE'
  })
  ...
  // Refund
  Order.hasMany(RefundOrder, {
    foreignKey: { name: 'orderId', field: 'order_id' },
    as: 'refundOrders',
    onDelete: 'CASCADE',
    onUpdate: 'CASCADE'
  })
  RefundOrder.belongsTo(Order, {
    foreignKey: { name: 'orderId', field: 'order_id' },
    as: 'order',
    onDelete: 'CASCADE',
    onUpdate: 'CASCADE'
  ...
  Payment.hasMany(RefundOrder, {
    foreignKey: { name: 'paymentId', field: 'payment_id' },
    as: 'refunds',
    onDelete: 'RESTRICT',
    onUpdate: 'CASCADE'
  })
  RefundOrder.belongsTo(Payment, {
    foreignKey: { name: 'paymentId', field: 'payment_id' },
    as: 'payment',
    onDelete: 'RESTRICT',
    onUpdate: 'CASCADE'
  ...
  RefundOrder.hasMany(RefundImage, {
    foreignKey: { name: 'refundOrderId', field: 'refund_order_id' },
    as: 'images',
    onDelete: 'CASCADE',
    onUpdate: 'CASCADE'
  })
  RefundImage.belongsTo(RefundOrder, {
    foreignKey: { name: 'refundOrderId', field: 'refund_order_id' },
    as: 'refundOrder',
    onDelete: 'CASCADE',
    onUpdate: 'CASCADE'
  ...
  RefundOrder.hasMany(RefundStatusHistory, {
    foreignKey: { name: 'refundOrderId', field: 'refund_order_id' },
    as: 'statusHistory',
    onDelete: 'CASCADE',
    onUpdate: 'CASCADE'
  })
  RefundStatusHistory.belongsTo(RefundOrder, {
    foreignKey: { name: 'refundOrderId', field: 'refund_order_id' },
    as: 'refundOrder',
    onDelete: 'CASCADE',
    onUpdate: 'CASCADE'
  ...
  ShippingInfo.belongsTo(ShippingType, {
    foreignKey: { name: 'shippingTypeId', field: 'shipping_type_id' },
    as: 'shippingType',
    onDelete: 'RESTRICT',
    onUpdate: 'CASCADE'
  })
  ShippingType.hasMany(ShippingInfo, {
    foreignKey: { name: 'shippingTypeId', field: 'shipping_type_id' },
    as: 'shippingInfos',
    onDelete: 'RESTRICT',
    onUpdate: 'CASCADE'
  ...
  // PaymentGatewayEvent
  CheckOut.hasOne(PaymentGatewayEvent, {
    foreignKey: { name: 'checkoutId', field: 'checkout_id' },
    as: 'gatewayEvents',
    onDelete: 'CASCADE',
    onUpdate: 'CASCADE'
  })
  PaymentGatewayEvent.belongsTo(Order, {
    foreignKey: { name: 'checkoutId', field: 'checkout_id' },
    as: 'order',
    onDelete: 'CASCADE',
    onUpdate: 'CASCADE'
  ...
  Payment.hasMany(PaymentGatewayEvent, {
    foreignKey: { name: 'paymentId', field: 'payment_id' },
    as: 'gatewayEvents',
    onDelete: 'CASCADE',
    onUpdate: 'CASCADE'
  })
  PaymentGatewayEvent.belongsTo(Payment, {
    foreignKey: { name: 'paymentId', field: 'payment_id' },
    as: 'payment',
    onDelete: 'CASCADE',
    onUpdate: 'CASCADE'
  ...
  RefundOrder.hasMany(PaymentGatewayEvent, {
    foreignKey: { name: 'refundOrderId', field: 'refund_order_id' },
    as: 'gatewayEvents',
    onDelete: 'SET NULL',
    onUpdate: 'CASCADE'
  })
  PaymentGatewayEvent.belongsTo(RefundOrder, {
    foreignKey: { name: 'refundOrderId', field: 'refund_order_id' },
    as: 'refundOrder',
    onDelete: 'SET NULL',
    onUpdate: 'CASCADE'
  ...
  AdminUser.hasMany(AdminPasswordReset, {
    foreignKey: { name: 'adminId', field: 'admin_id' },
    as: 'passwordResets',
    onDelete: 'CASCADE',
    onUpdate: 'CASCADE'
  })
  AdminPasswordReset.belongsTo(AdminUser, {
    foreignKey: { name: 'adminId', field: 'admin_id' },
    as: 'admin',
    onDelete: 'CASCADE',
    onUpdate: 'CASCADE'
  ...
  AdminUser.hasMany(AdminInvite, {
    foreignKey: { name: 'invitedByAdminId', field: 'invited_by_admin_id' },
    as: 'invites',
    onDelete: 'RESTRICT',
    onUpdate: 'CASCADE'
  })
  AdminInvite.belongsTo(AdminUser, {
    foreignKey: { name: 'invitedByAdminId', field: 'invited_by_admin_id' },
    as: 'invitedBy',
    onDelete: 'RESTRICT',
    onUpdate: 'CASCADE'
  ...
  AdminUser.hasMany(AdminMfaFactor, {
    foreignKey: { name: 'adminId', field: 'admin_id' },
    as: 'mfaFactors',
    onDelete: 'CASCADE',
    onUpdate: 'CASCADE'
  })
  AdminMfaFactor.belongsTo(AdminUser, {
    foreignKey: { name: 'adminId', field: 'admin_id' },
    as: 'admin',
    onDelete: 'CASCADE',
    onUpdate: 'CASCADE'
  ...
  AdminUser.hasMany(AdminMfaChallenge, {
    foreignKey: { name: 'adminId', field: 'admin_id' },
    as: 'mfaChallenges',
    onDelete: 'CASCADE',
    onUpdate: 'CASCADE'
  })
  AdminMfaChallenge.belongsTo(AdminUser, {
    foreignKey: { name: 'adminId', field: 'admin_id' },
    as: 'admin',
    onDelete: 'CASCADE',
    onUpdate: 'CASCADE'
  ...
  AdminUser.hasMany(AdminRecoveryCode, {
    foreignKey: { name: 'adminId', field: 'admin_id' },
    as: 'recoveryCodes',
    onDelete: 'CASCADE',
    onUpdate: 'CASCADE'
  })
  AdminRecoveryCode.belongsTo(AdminUser, {
    foreignKey: { name: 'adminId', field: 'admin_id' },
    as: 'admin',
    onDelete: 'CASCADE',
    onUpdate: 'CASCADE'
  ...
  AdminUser.hasMany(AdminApiKey, {
    foreignKey: { name: 'adminId', field: 'admin_id' },
    as: 'apiKeys',
    onDelete: 'CASCADE',
    onUpdate: 'CASCADE'
  })
  AdminApiKey.belongsTo(AdminUser, {
    foreignKey: { name: 'adminId', field: 'admin_id' },
    as: 'admin',
    onDelete: 'CASCADE',
    onUpdate: 'CASCADE'
  ...
  AdminUser.hasMany(AdminSystemLog, {
    foreignKey: { name: 'adminId', field: 'admin_id' },
    as: 'logs',
    onDelete: 'CASCADE',
    onUpdate: 'CASCADE'
  })
  AdminSystemLog.belongsTo(AdminUser, {
    foreignKey: { name: 'adminId', field: 'admin_id' },
    as: 'admin',
    onDelete: 'CASCADE',
    onUpdate: 'CASCADE'
  ...
  AdminPermission.hasMany(AdminRolePermission, {
    foreignKey: { name: 'permissionId', field: 'permission_id' },
    as: 'permissionRoles',
    onDelete: 'CASCADE',
    onUpdate: 'CASCADE'
  })
  AdminRolePermission.belongsTo(AdminPermission, {
    foreignKey: { name: 'permissionId', field: 'permission_id' },
    as: 'permission',
    onDelete: 'CASCADE',
    onUpdate: 'CASCADE'
  ...
  AdminUser.hasMany(AdminUserRole, {
    foreignKey: { name: 'adminId', field: 'admin_id' },
    as: 'userRoles',
    onDelete: 'CASCADE',
    onUpdate: 'CASCADE'
  })
  AdminUserRole.belongsTo(AdminUser, {
    foreignKey: { name: 'adminId', field: 'admin_id' },
    as: 'admin',
    onDelete: 'CASCADE',
    onUpdate: 'CASCADE'
  ...
  AdminRole.hasMany(AdminUserRole, {
    foreignKey: { name: 'roleId', field: 'role_id' },
    as: 'userRoles',
    onDelete: 'CASCADE',
    onUpdate: 'CASCADE'
  })
  AdminUserRole.belongsTo(AdminRole, {
    foreignKey: { name: 'roleId', field: 'role_id' },
    as: 'role',
    onDelete: 'CASCADE',
    onUpdate: 'CASCADE'
