...
const MATRIX: MapMatrix = {
  SUPER_ADMIN: [
    ...
    "ORDERS_READ", "ORDERS_EXPORT",
    "REFUNDS_READ", "REFUNDS_EXPORT",
    "PRODUCTS_READ", "PRODUCTS_UPDATE",
    "CATEGORIES_READ", "CATEGORIES_CREATE", "CATEGORIES_UPDATE", "CATEGORIES_DELETE",
    "CUSTOMERS_READ", "CUSTOMERS_SUSPEND",
    "MERCHANTS_READ", "MERCHANTS_APPROVE", "MERCHANTS_SUSPEND",
    "ADMIN_USERS_READ", "ADMIN_USERS_CREATE", "ADMIN_USERS_UPDATE", "ADMIN_USERS_DELETE",
