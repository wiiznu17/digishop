  ...
  up: async (queryInterface: QueryInterface) => {
    ...
    await queryInterface.bulkInsert("ORDER_STATUS_HISTORY", [
      ...
      },
      {
        ...
        changed_by_type: "MERCHANT",
        changed_by_id: 1,
        reason: "Requested cancel (pre-ship)",
        source: "APP",
        correlation_id: "req-6022-d",
        metadata: JSON.stringify({}),
        created_at: now,
        updated_at: now,
      },
      ...
      },
      {
        ...
        changed_by_type: "CUSTOMER",
        changed_by_id: 1,
        reason: "Requested refund (post-ship)",
        source: "APP",
        correlation_id: "req-6022-g",
        metadata: JSON.stringify({}),
        created_at: now,
        updated_at: now,
      },
