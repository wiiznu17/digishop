    ...
    RefundStatusHistory.init(
      {
        ...
        refundOrderId: { type: DataTypes.INTEGER.UNSIGNED, allowNull: false, field: "refund_order_id" },
        fromStatus: {
        ...
        source: { type: DataTypes.STRING(50), allowNull: true, field: "source" },
      ...
      },
      {
        ...
        indexes: [
          { name: "idx_rsh_refund_order_created", fields: ["refund_order_id", "created_at"] },
          { name: "idx_rsh_to_status_created", fields: ["to_status", "created_at"] },
          { name: "idx_rsh_changed_by", fields: ["changed_by_type", "changed_by_id"] },
        ],
      }
    );
