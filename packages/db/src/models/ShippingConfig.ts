...
export interface ShippingConfigCreationAttributes
  extends Optional<ShippingConfigAttributes, 'id' | 'pickupTime' | 'isActive' | 'createdAt' | 'updatedAt'> {}

export class ShippingConfig extends Model<ShippingConfigAttributes, ShippingConfigCreationAttributes>
