...
export interface AdminMfaChallengeCreationAttributes
  extends Optional<AdminMfaChallengeAttributes, "id" | "resolvedAt" | "attempts" | "metadataJson" | "createdAt" | "updatedAt" | "deletedAt"> {}

export class AdminMfaChallenge extends Model<AdminMfaChallengeAttributes, AdminMfaChallengeCreationAttributes>
    ...
    AdminMfaChallenge.init(
      {
        ...
        factorType: { type: DataTypes.ENUM(...Object.values(MfaFactorType)), allowNull: false, field: "factor_type" },
        challengeId: { type: DataTypes.STRING(36), allowNull: false, unique: true, field: "challenge_id" },
        status: { type: DataTypes.ENUM(...Object.values(MfaChallengeStatus)), allowNull: false, defaultValue: MfaChallengeStatus.PENDING },
      ...
      },
      {
        ...
        indexes: [{ fields: ["admin_id"] }, { unique: true, fields: ["challenge_id"] }],
      }
    );
