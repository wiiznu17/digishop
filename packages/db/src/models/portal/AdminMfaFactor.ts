...
export class AdminMfaFactor
  extends Model<AdminMfaFactorAttributes, AdminMfaFactorCreationAttributes>
    ...
    AdminMfaFactor.init(
      {
        ...
        secretOrPublic: {
          type: DataTypes.TEXT,
          allowNull: true,
          field: 'secret_or_public'
        },
        label: { type: DataTypes.STRING(191), allowNull: true },
        status: {
          type: DataTypes.ENUM(...Object.values(MfaFactorStatus)),
          allowNull: false,
          defaultValue: MfaFactorStatus.ACTIVE
        },
        addedAt: {
          type: DataTypes.DATE,
          allowNull: false,
