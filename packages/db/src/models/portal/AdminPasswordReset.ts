...
export interface AdminPasswordResetCreationAttributes
  extends Optional<AdminPasswordResetAttributes, "id" | "usedAt" | "createdAt" | "updatedAt" | "deletedAt"> {}

export class AdminPasswordReset extends Model<AdminPasswordResetAttributes, AdminPasswordResetCreationAttributes>
