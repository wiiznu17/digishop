...
export interface AdminApiKeyCreationAttributes
  extends Optional<AdminApiKeyAttributes, "id" | "uuid" | "keyId" | "scopesJson" | "lastUsedAt" | "expiresAt" | "createdAt" | "updatedAt" | "deletedAt"> {}

export class AdminApiKey extends Model<AdminApiKeyAttributes, AdminApiKeyCreationAttributes>
    ...
    AdminApiKey.init(
      {
        ...
        keyHash: { type: DataTypes.STRING(191), allowNull: false, field: "key_hash" },
        scopesJson: { type: DataTypes.JSON, allowNull: true, field: "scopes_json" },
      ...
      },
      {
        ...
        indexes: [{ fields: ["admin_id"] }, { fields: ["key_id"] }, { unique: true, fields: ["key_hash"] }],
      }
    );
    return AdminApiKey;
  }
