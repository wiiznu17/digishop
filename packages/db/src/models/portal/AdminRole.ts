...
export interface AdminRoleCreationAttributes
  extends Optional<AdminRoleAttributes, "id" | "uuid" | "description" | "isSystem" | "createdAt" | "updatedAt" | "deletedAt"> {}
    ...
    AdminRole.init(
      {
        ...
        isSystem: { type: DataTypes.BOOLEAN, allowNull: false, field: "is_system", defaultValue: false },
